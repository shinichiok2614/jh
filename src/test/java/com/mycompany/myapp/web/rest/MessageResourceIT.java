...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().content(DEFAULT_CONTENT).createdAt(DEFAULT_CREATED_AT).status(DEFAULT_STATUS);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
        return message;
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
    ...
    void partialUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.status(UPDATED_STATUS);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
