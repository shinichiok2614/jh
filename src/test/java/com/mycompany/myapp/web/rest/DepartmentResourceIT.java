...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).thumbnail(DEFAULT_THUMBNAIL);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().name(UPDATED_NAME).thumbnail(UPDATED_THUMBNAIL);
        return department;
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).thumbnail(UPDATED_THUMBNAIL);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).thumbnail(UPDATED_THUMBNAIL);
