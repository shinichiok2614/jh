...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().description(DEFAULT_DESCRIPTION).createdAt(DEFAULT_CREATED_AT).updateAt(DEFAULT_UPDATE_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT).updateAt(UPDATED_UPDATE_AT);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT).updateAt(UPDATED_UPDATE_AT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.description(UPDATED_DESCRIPTION).createdAt(UPDATED_CREATED_AT).updateAt(UPDATED_UPDATE_AT);
