...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGELIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGELIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGELIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGELIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGELIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGELIST actions', async () => {
      const arg = 42666;
