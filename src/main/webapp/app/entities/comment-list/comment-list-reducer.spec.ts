...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMENTLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMENTLIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMENTLIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMENTLIST actions', async () => {
      const arg = 42666;
